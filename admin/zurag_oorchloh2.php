...
$sql="update dursgalt_gazar set Image2=:image2 where DU_id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Зураг 2 </h2>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Өмнө оруулсан зураг 2</label>
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Image2 from dursgalt_gazar where dursgalt_gazar.DU_id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Шинээр зураг 2 оруулах</label>
												<div class="col-sm-8">
