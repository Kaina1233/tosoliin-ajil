...
$error="Өмнөх нууц үг буруу байна.";	
}
}
?>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Нууц үг солих</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>Алдаа</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Өмнөх нууц үг</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Шинэ нууц үг</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Нууц үг баталгаажуулах</label>
												<div class="col-sm-8">
