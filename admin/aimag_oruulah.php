...
{
$aimagg=$_POST['aimagg'];
$sql="INSERT INTO  aimag(aimag_ner) VALUES(:aimagg)";
$query = $dbh->prepare($sql);
$query->bindParam(':aimagg',$aimagg,PDO::PARAM_STR);
$query->execute();
...
{
$error="алдаатай байна, дахин оролдоно уу";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Аймаг үүсгэх</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>Алдаа</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="aimagg" id="aimagg" required>
												</div>
											</div>
