...
$brand=$_POST['brand'];
$id=$_GET['id'];
$sql="update aimag set aimag_ner=:brand where aimag_id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Аймгийн нэр</h2>
...
<?php	
$id=$_GET['id'];
$ret="select * from aimag where aimag_id=:id";
...
?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Аймгийн нэр</label>
												<div class="col-sm-8">
													<input type="text" class="form-control" value="<?php echo htmlentities($result->aimag_ner);?>" name="brand" id="brand" required>
												</div>
											</div>
